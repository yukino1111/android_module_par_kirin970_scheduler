...
required=(
  ...
  sepolicy.rule
  bin/control.sh bin/daemon.sh bin/engine.sh lib/common.sh
...
for script in customize.sh post-fs-data.sh service.sh post-mount.sh uninstall.sh action.sh bin/control.sh bin/daemon.sh bin/engine.sh lib/common.sh; do
